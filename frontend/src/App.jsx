...
export default function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-black antialiased font-sans selection:bg-sky-100 selection:text-black">
      {/* Top Navigation Bar */}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Main Content Area */}
        <main className="flex-1 p-5 md:p-6 overflow-y-auto bg-white max-w-7xl mx-auto w-full">
